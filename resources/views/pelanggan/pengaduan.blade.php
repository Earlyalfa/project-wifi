                    ...
                    <form action="{{ route('pelanggan.pengaduan.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="jenis_gangguan"
                                    class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all @error('jenis_gangguan') border-rose-300 bg-rose-50 @enderror">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="judul_keluhan" value="{{ old('judul_keluhan') }}"
                                   ...
                                   class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all @error('judul_keluhan') border-rose-300 bg-rose-50 @enderror">
                            @error('judul_keluhan')
                                <p class="text-xs text-rose-500 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="deskripsi" rows="5"
                                      ...
                                      class="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all @error('deskripsi') border-rose-300 bg-rose-50 @enderror">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <p class="text-xs text-rose-500 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input type="file" name="foto" id="foto"
                                       ...
                                       class="w-full text-sm text-slate-500 file:mr-4 file:py-2.5 file:px-5 file:rounded-xl file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100 transition-all cursor-pointer">
                            </div>
                        ...
                        <div class="mt-6 flex justify-end">
                            <button type="submit"
                                    class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-md shadow-indigo-600/20">
                ...
                <tbody class="divide-y divide-slate-50">
                    @forelse ($pengaduans as $index => $p)
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-5 py-3">
                                @if ($p->foto)
                                    <a href="{{ asset('storage/' . $p->foto) }}" target="_blank" class="inline-flex items-center gap-1 text-xs text-indigo-600 hover:underline">
                            ...
                            <td class="px-5 py-3">
                                <a href="{{ route('pelanggan.pengaduan.show', $p) }}" class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-semibold bg-indigo-100 text-indigo-700 hover:bg-indigo-200 transition-all">
