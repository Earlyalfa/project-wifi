        ...
        <form action="{{ route('admin.paket.update', $paket) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="deskripsi" rows="4"
                          ...
                          class="w-full rounded-lg border border-slate-200 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-violet-400 @error('deskripsi') border-rose-300 @enderror">{{ old('deskripsi', $paket->deskripsi) }}</textarea>
